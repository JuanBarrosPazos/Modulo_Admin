...
function process_form(){
	...
	global $twhile;
	$twhile = "FILTRO USUARIOS BAJAS BORRAR";

	global $formularioh;
	$formularioh = "<form name='modifica' action='Feedback_Admin_Borrar_02.php' method='POST'>";

	global $formulariof;
	$formulariof = "<td colspan=5 class='BorderInf'>&nbsp;</td>
					<td colspan=2 align='center' class='BorderInf'>
						<input type='submit' value='BORRAR DATOS EMPLEADO' />
...
if (($_SESSION['Nivel'] == 'admin')){ 
	...
	global $twhile;
	$twhile = "TODOS USUARIOS BAJAS BORRAR";
...
function info(){
	...
	$dir = "../Users/".$_SESSION['ref']."/log";
		...
		global $text;
		$text = PHP_EOL."- USER BAJA BUSCAR ".$ActionTime.PHP_EOL."\t Filtro => ".$nombre." ".$apellido;
