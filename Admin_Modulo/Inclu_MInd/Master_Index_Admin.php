...
if ($_SESSION['dni'] == $_SESSION['mydni']) {
	...
	print("<li>
		...
		<ul class='nav-flyout'>
			...
			<li>
				<a href='#' style='background-color: #343434;padding-bottom: 170px;'>
				</a>
			</li>
		</ul>
	</li>");
	...
	print("<li>
			...
			<ul class='nav-flyout'>
				...
				<li>
					<a href='Feedback_Admin_Recuperar_01.php'>
		...
		<li>
			...
			<ul class='nav-flyout'>
				...
				<li>
					<a href='#'><i class='ic ico10b'></i>MIS BALANCES</a>
				</li>
				<li>
					<a href='#'>
		...
		<li>
			<a href='#'>
				<i class='ic ico20'></i><span>QR CODES</span>
			</a>
			<ul class='nav-flyout'>
				<li>
